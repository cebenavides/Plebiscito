...
<%
    try{
        ...
        ResultSet tabla1 = instruccion1.executeQuery( "SELECT SUM(voto) as total FROM votos WHERE idpuesto= "+id+" ");
        ResultSet tabla2 = instruccion2.executeQuery( "select count(voto) from votos WHERE idpuesto="+id+"");
        tabla1.next();
        tabla2.next();
